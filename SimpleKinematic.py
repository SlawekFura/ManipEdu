            ...
            for lambdaIt, lambdaRange in lambda_Coord.items():
                for _ in lambdaRange:
                    ...
                    for transMatrixIt in range(0, dhColumnSize):
                        ...
                        # print(lambda_Coord[transMatrixIt][0])
                        # print(lambda_Coord[transMatrixIt])
                        # print(lambdaValIter[transMatrixIt])
                        # print("thetaNameIter", thetaNameIter)
                        # print("thetaValIter", thetaValIter[transMatrixIt])

                        # print("theta" + str(transMatrixIt), round(theta,2), "alpha", round(alpha_Coord[transMatrixIt][0],2), "a", round(a_Coord[transMatrixIt][0],2), "lambda", round(lambda_,2))
